...
const greetHello = (str: string | string[]) => {
...
const greetHello1 = (str: string | string[]) => {
...
console.log(greetHello("Jerald"));
console.log(greetHello(["Jerald", "Mark", "Krisha"]));
console.log(greetHello1("Jerald"));
console.log(greetHello1(["Jerald", "Mark", "Krisha"]));
